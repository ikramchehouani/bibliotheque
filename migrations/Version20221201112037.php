 ...
 */
final class Version20221201112037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD lastname VARCHAR(100) NOT NULL, ADD firstname VARCHAR(100) NOT NULL');
    }
